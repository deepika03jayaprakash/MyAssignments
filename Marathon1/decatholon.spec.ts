...
test('DecatholonAddtoCart', async ({ page }) => {
    ...
    //await page.getByRole('button',{name:"Close"}).click({force:true})  // How to close the pop up?
...
/*Not able to close the some promotional popup in decatholon page after add to cart. tried different way - used escape and force:true and locator but nothing working
1. Esc:await page.keyboard.press('Escape');
2.click({ force: true })
3. X playwright locator not worked. but css selector worked. 
