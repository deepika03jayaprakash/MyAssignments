...
test('editLead_Validation', async ({ page }) => { //Using page fixer in this test method
    ...
    await page.locator('[class="subMenuButton"]').nth(2).click()
    await page.locator('[id="updateLeadForm_companyName"]').fill('Google')
